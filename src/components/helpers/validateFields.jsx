// Reg expressions
export const regExpProductName = /^[A-Za-z\s?]+$/;
export const regExpPrice = /[0-9]+$/;
export const regExpUrl = /^https?:\/\/[\w\-]+(\.[\w\-]+)+[/#?]?.*$/;
export const regExpCategory = /^[A-Za-z\-\s?]+$/;
export const regExpAvaliable = /^[A-Za-z\-\s?]+$/;
export const regExpPorcentaje=/^((100(\.0{1,2})?)|(\d{1,2}(\.\d{1,2})?))$/;
