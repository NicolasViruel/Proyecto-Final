...
const GridProducts = () => {
  ...
  return (
    ...
    <Container fluid className=' bg-black'>
      <div className='row text-center d-flex justify-content-center bg-black'>
        {arrayProducts.map((product) => (
          <CardProduct key={product.title} title={product.title} src={product.src} description={product.description} />
        ))}
      </div>
    </Container>
  )
